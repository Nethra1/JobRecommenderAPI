...
class Scraper:
    ...
    def main(self, position, location):
        ...
        with concurrent.futures.ThreadPoolExecutor() as executor:
            allJobsIndeed = executor.submit(self.indeed_thread, position, location, numberOfJobs)
            allJobsLinkedIn = executor.submit(self.linkedin_thread, position, location, numberOfJobs)
            allJobsMonster = executor.submit(self.monster_thread, position, location, numberOfJobs)
